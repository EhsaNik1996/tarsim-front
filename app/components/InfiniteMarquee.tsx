...
export default function InfiniteMarquee() {
  return (
    <div className="flex flex-col gap-4 h-60 justify-center">
      {/* ردیف اول */}
      <div className="relative md:w-full -rotate-1 overflow-hidden flex items-center select-none">
        ...
        <div
          className="flex shrink-0 animate-marquee gap-16 min-w-full justify-around md:pr-16"
          dir="rtl"
          aria-hidden="true"
        >
          {marqueeItemsRow1.map((text, idx) => (
            ...
            >
              <span className="text-xl md:text-2xl font-black text-zinc-400 tracking-tight uppercase">
                {text}
              </span>
      ...
      <div className="relative w-full -rotate-1 h-32 overflow-hidden flex items-center select-none bg-electric-blue">
        <div className="absolute inset-y-0 left-0 w-24 bg-linear-to-r from-electric-blue to-transparent z-10 pointer-events-none" />
        <div className="absolute inset-y-0 right-0 w-24 bg-linear-to-l from-electric-blue to-transparent z-10 pointer-events-none" />
        ...
        >
          {marqueeItemsRow2.map((text, idx) => (
            <div
              ...
              className="flex items-center gap-6 shrink-0"
            >
              <span className="text-2xl md:text-4xl font-black text-white tracking-tight uppercase">
                {text}
              </span>
