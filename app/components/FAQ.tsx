...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "بسته به مسئله، راهکار می‌تواند مهندسی و توسعه کاملاً اختصاصی باشد یا بر محصولات تخصصی ترسیم مانند داکیباکس و هپینو تکیه کند. معیار انتخاب، تناسب راهکار با نیاز و مسیر رشد سازمان است.",
  },
];
