...
export default function AboutChecks() {
  return (
    <section className="w-full bg-white" dir="rtl">
      <div className="mx-auto w-full max-w-360 px-6 py-20 md:px-16 md:pt-14 md:pb-24">
        <div className="grid grid-cols-1 items-end gap-10 pb-10 md:grid-cols-2 md:gap-24">
          <BlurReveal>
            ...
            <h2 className="mt-5 md:mt-28 max-w-2xl text-4xl leading-none font-black tracking-tighter md:text-5xl">
              چهار اصل که
              <br />
              در طول مسیر
              <br />
        ...
        <div className="border-t border-black">
          {checks.map((item) => (
            ...
            >
              <span className={`w-12 shrink-0 text-[10px] font-space-grotesk font-semibold ${item.color}`}>
                {item.number}
              </span>
